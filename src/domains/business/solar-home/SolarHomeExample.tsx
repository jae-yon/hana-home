...
const EXAMPLE_IMAGES = [
  {
    src: portfolioHomeImage04,
    alt: '가정용 태양광 시공 사례 1',
  },
  {
    src: portfolioHomeImage02,
    alt: '가정용 태양광 시공 사례 2',
  },
];

export default function SolarHomeExample() {
  return (
    <Box
      as="section"
      bg="gray.900"
    ...
    >
      ...
      <Box maxW="1200px" margin="0 auto" position="relative" zIndex={1}>
        ...
        <Box textAlign={{ base: 'center', md: 'left' }}>
          <RouterLink to="/portfolio/residential" style={{ textDecoration: 'none', display: 'inline-block' }}>
            <Box
              as="span"
              display="inline-flex"
              alignItems="center"
