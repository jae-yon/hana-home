    ...
    >
      {summaryCards.map((card) => (
        <Box 
          ...
          _hover={card.type === type ? { boxShadow: "md", transform: "scale(1.02)", transition: "all 0.5s ease-in-out" } : {}}
        >
          {/* Card Header */}
          <Box 
            px={6} 
            ...
            bg={card.type === type ? "orange.500" : "gray.400"} 
          >
          ...
          {/* Card Body */}
          <Box px={6} py={4}>
            <Text fontSize="xl" color={card.type === type ? "orange.500" : "gray.400"} fontWeight="800" fontFamily="NanumSquareNeo" textAlign="center">
              {card.best_for}
            </Text>
            <Text fontSize="lg" color={card.type === type ? "gray.700" : "gray.400"} fontWeight="700" fontFamily="pretendard" textAlign="center">
              {card.highlight}
            </Text>
            ...
            <SimpleGrid columns={3} gap={4} mt={4}>
              {card.pros.map((p, i) => (
                <Box
                  ...
                  borderColor="gray.200"
                  color="white"
                  backgroundColor={card.type === type ? "orange.500" : "gray.400"}
                >
                  <LucideCircleCheck
                    size={32}
                    strokeWidth={1.5}
